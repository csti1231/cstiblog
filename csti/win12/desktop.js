        ...
        path: {
            folder: {
                                ...
                                'csti': {
                                    folder: {
                                        '文档': {
                                            ...
                                            file: [
                                                { name: 'csti介绍.doc', ico: 'icon/files/word.png', command: '' },
                                                { name: 'csti质量统计分析.xlsx', ico: 'icon/files/excel.png', command: '' },
                                            ]
                                        }, '图片': {
                                            folder: { '本机照片': null, '屏幕截图': null },
                                            file: [
                                                { name: 'csti构造图.png', ico: 'icon/files/img.png', command: '' },
                                                { name: '可口可乐csti.jpg', ico: 'icon/files/img.png', command: '' },
                                            ]
                                        },
                ...
                'D:': {
                    ...
                    file: [
                        { name: 'csti结构说明.docx', ico: 'icon/files/word.png', command: '' },
                        { name: '可口可乐csti历史.pptx', ico: 'icon/files/ppt.png', command: '' },
                    ]
                }
            }
        }
...
或批处理文件`;
    ...
    search: {
        rand: [{ name: '农夫山泉csti简介.txt', bi: 'text', ty: '文本文档' },
        { name: 'csti构造图.png', bi: 'image', ty: 'PNG 文件' },
        { name: 'csti结构说明.docx', bi: 'richtext', ty: 'Microsoft Word 文档' },
        { name: '可口可乐csti.jpg', bi: 'image', ty: 'JPG 文件' },
        { name: '可口可乐csti历史.pptx', bi: 'slides', ty: 'Microsoft Powerpoint 演示文稿' },
        { name: 'csti质量统计分析.xlsx', bi: 'ruled', ty: 'Microsoft Excel 工作表' },
        { name: '农夫山泉csti.svg', bi: 'image', ty: 'SVG 文件' },
        { name: 'csti介绍.doc', bi: 'richtext', ty: 'Microsoft Word 文档' }],
        search: le => {
            if (le > 0) {
