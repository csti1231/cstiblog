 ...
 */
        ...
        function Ie(e, t, n) {
            for (var r, o = t ? C.filter(t, e) : e, i = 0; null != (r = o[i]); i++)
                ...
                r.parentNode && (n && ae(r) && ye(me(r, "script")),
...
, function(e, t, n) {
    ...
    function c(e) {
        ...
        var t = e.name
          ...
          , s = e.dynasty;
        return "\n    <li class='name-box'>\n        <h3>" + (0,
        r.default)('input[name="family-name"]').val() + t + "</h3>\n        <p class='sentence'>\n          <span>「</span>\n          " + n.replace(new RegExp("[" + t + "]","ig"), function(e) {
            return "<i>" + e + "</i>"
        }) + "\n          <span>」</span>\n        </p>\n        <div class='source-row' >\n          <div class='book'>" + a + "&nbsp;•&nbsp;" + o + "</div>\n          <div class='author'>[" + s + "]&nbsp;" + (i || "佚名") + "</div>\n        </div>\n      </li>"
    }
    function f() {
        l = setTimeout(function() {
            (0,
            r.default)(".loader").css({
                display: "block"
            })
        }, 300)
    }
    ...
    function d(e) {
        var t = (0,
        r.default)("input[name='book']:checked").val();
        f(),
    ...
    r.default)(document).ready(function() {
        ...
        function(e) {
            (0,
            r.default)("input[name='book']").change(function(t) {
                d(e)
            }),
            u(".btn-go").addEventListener("click", function() {
                ...
                (0,
                r.default)(".result-container").html(n.join("")),
                p()
            }, !1)
        }(e)
    }),
